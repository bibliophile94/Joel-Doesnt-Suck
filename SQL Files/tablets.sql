...
--
-- Host: localhost
-- Generation Time: Apr 29, 2015 at 11:05 AM
...
(4, 4, 'John', 'Father', 'Jim', 'Gacy', 'Clown', 'Mr.', 4, 'Role Model'),
(5, 5, 'Emily', 'Dad', 'Grandma', 'Dickenson', 'Poet', 'Ms.', 5, 'Dead'),
(6, 6, 'Martha', 'Joe', 'Bob', 'Stewart', 'Criminal', 'Mrs.', 6, 'Mother'),
(7, 7, 'Jimi', 'Dad', 'Uncle', 'Hendrix', 'Rocker', 'Mr.', 7, 'Musician'),
(8, 8, 'Freddy', 'Dale', 'Frank', 'Mercury', 'Rocker', 'Mr.', 8, 'Awesome'),
(9, 9, 'Griffin', 'Todd', 'Fred', 'Polonus', 'IronMan', 'Mr.', 9, 'Philanthropist'),
(10, 10, 'Nick', 'Vinny', 'Grandpa', 'Schreiner', 'TeamLeader', 'Mr.', 10, 'Victory!');
